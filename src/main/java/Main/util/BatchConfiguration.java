...
public class BatchConfiguration {
  ...
  @Bean
  public FlatFileItemReader<RawMatchData> reader() {
    return new FlatFileItemReaderBuilder<RawMatchData>()
      .name("personItemReader")
      .resource(new ClassPathResource("matchdata.csv"))
      .delimited()
      .names(FIELD_NAME)
      .fieldSetMapper(new BeanWrapperFieldSetMapper<RawMatchData>() {{
        setTargetType(RawMatchData.class);
      }})
      .build();
  }
